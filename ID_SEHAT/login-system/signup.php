...
<body>
  <section class="form-signin text-end">
    ...
    <form class="text-center" id="daftar">
      <img class="mb-2" src="../assets/logo/logo.png" alt="" width="72" height="57">
      <h1 class="h3 mb-4 fw-normal">SIGN UP</h1>

      <div class="form-floating mb-2">
        <input type="text" class="form-control" id="floatingInput" placeholder="fname lname">
      ...
      <button class="btn btn-lg px-4 mb-4" type="submit">Daftar</button>
